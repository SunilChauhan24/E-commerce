...
module.exports = {
  createProduct, // yaha pr createMultipleProduct
  deleteProduct,
  updateProduct,
  getAllProducts,
  findProductById,
  createMultipleProduct, // same yaha pr createMultipleProduct, createProduct call hi nhi kiya
};

// DONE?  are sir genius ho aap bsbsb thank you so much sir e bhai h re tu aram se kr ab aage GN ha sir thanks good night aapko thanks again sir
